...
import { termsIntro, termsLastUpdated, termsSections } from "@/lib/termsAndConditionsContent";
      ...
      <main className="bg-neutral-50 pb-24">
        <Container className="pt-14">
          <div className="text-center">
            ...
            <p className="mt-3 text-[13px] font-semibold uppercase tracking-wide text-[#5a6a80]">
          ...
          <div className="mt-12 flex flex-col gap-6 lg:flex-row lg:items-stretch lg:gap-10">
            <div className="lg:hidden">
              <LegalMobileToc sections={termsSections} />
            </div>
            <LegalTableOfContents sections={termsSections} />
              ...
              <LegalSections
                ...
                closing={
                  <>
                    ...
                    <p className="mt-1 font-semibold text-[#0d1b3e]">Holidays Center Team</p>
                  </>
                }
              />
            </div>
